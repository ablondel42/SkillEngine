#!/usr/bin/env python3
"""
Static Test Suite - NO subagents, NO API calls.

Runs all static analysis tests that don't require subagent execution.
Perfect for CI/CD, pre-commit checks, and quota-limited situations.

Usage: python static_test_suite.py <skill_directory>
"""
...
def main():
    if len(sys.argv) != 2:
        print("Usage: python static_test_suite.py <skill_directory>")
        sys.exit(1)
